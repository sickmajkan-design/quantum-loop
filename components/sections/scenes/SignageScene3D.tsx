...
/**
 * Preserved CSS 3D "lightbox" sign (front → side → back on scroll). Kept as a
 * fallback/revert option after the scene moved to a realistic Higgsfield video
 * (see SignageScene.tsx). To restore it, import this from Services instead.
 */
export default function SignageScene3D({
  rowRef,
}: {
