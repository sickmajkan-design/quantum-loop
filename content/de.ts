...
const de: Dictionary = {
  ...
  hero_title: "Design, das |haftet.",
  hero_sub:
    "Grafikdesign, Werbetechnik aller Art, Fahrzeugbeschriftung und Scheibentönung. Von der Idee bis zur Montage — mit Garantie auf jede Arbeit.",
  hero_cta1: "Angebot anfordern",
  hero_cta2: "Leistungen ansehen",

  s_eyebrow: "Leistungen",
  s_title: "Alles, was man sieht — machen wir.",
  s1_t: "Grafikdesign",
  s1_p: "Logos, visuelle Identitäten und Druckvorlagen. Design, das Ihre Marke auf den ersten Blick unverwechselbar macht.",
  s2_t: "Fahrzeugfolierung",
  ...
  g_eyebrow: "Warum wir",
  g_title: "Jahre Handwerk. Garantie auf jede Arbeit.",
  g1_t: "Garantie",
  g1_p: "Schriftliche Garantie auf jede Arbeit — Material und Montage.",
  g2_t: "Erfahrung",
  g2_p: "Über 20 Jahre im Handwerk. Wir wissen, was funktioniert.",
  g3_t: "Alles aus einer Hand",
  g3_p: "Design, Produktion und Montage — an einem Ort.",
